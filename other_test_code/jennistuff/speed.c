...
void app_main() {
    ...
    while (1) {
        ...
        char speedstring[4];
        itoa(speed, speedstring, 10);
        
        int first = speedstring[0] - 32;
        int second = speedstring[1] - 32;
        int third = speedstring[2] - 32;
        int fourth = speedstring[3] - 32;
        ...
        displaybuffer[0] = alphafonttable[first];
        displaybuffer[1] = alphafonttable[second];
